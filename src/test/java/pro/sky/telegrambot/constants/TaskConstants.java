...
public class TaskConstants {
    ...
    public static final LocalDateTime TIME_TASK_1 = LocalDateTime.parse("2024-08-01 21:00:00", DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss"));
    public static final LocalDateTime TIME_TASK_2 = LocalDateTime.parse("2024-08-01 21:00:00", DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss"));
    public static final LocalDateTime TIME_TASK_3 = LocalDateTime.parse("2024-08-01 21:00:00", DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss"));
