...
class TaskServiceTest {
    ...
    void createNotificationTaskTest() {
        ...
        task1.setChatId(1L);
        LocalDateTime dateTime = LocalDateTime.parse("2024-08-13 10:37",
        ...
        assertThat(task1).isSameAs(service.create(1L, "13.08.2024 10:37", "Текст"));
    ...
    void getNotificationTasksByTaskTime() {
        LocalDateTime dateTime = LocalDateTime.parse("2024-08-13 10:37:00",
